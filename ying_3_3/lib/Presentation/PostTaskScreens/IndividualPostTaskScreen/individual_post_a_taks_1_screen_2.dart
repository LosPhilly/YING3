...
class IndividualPostATask1Screen_2 extends StatefulWidget {
  const IndividualPostATask1Screen_2({Key? key}) : super(key: key);

  @override
  State<IndividualPostATask1Screen_2> createState() =>
      _IndividualPostATask1Screen_2State();
}

class _IndividualPostATask1Screen_2State
    extends State<IndividualPostATask1Screen_2> {
