...
class CustomFloatingTextField extends StatelessWidget {
  ...
  Widget get floatingTextFieldWidget => Container(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumOnPrimary_3,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumOnPrimary_3,
        labelText: labelText ?? "",
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(15.h, 19.v, 15.h, 15.v),
        fillColor: fillColor,
        filled: filled,
...
extension FloatingTextFormFieldStyleHelper on CustomFloatingTextField {
  OutlineInputBorder get custom => OutlineInputBorder(
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get outlineOnPrimaryTL16 => OutlineInputBorder(
