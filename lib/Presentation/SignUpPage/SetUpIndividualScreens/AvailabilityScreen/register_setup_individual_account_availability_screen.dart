              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      "People will be able to request you during these hours on your open days.",
                      style: TextStyle(
                          color: Colors.grey,
                          fontFamily: 'Poppins',
                          fontSize: 14,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 24),
                    child: Text(
                      "People will be able to request you on the days you mark open.",
                      style: TextStyle(
                          color: Colors.grey,
                          fontSize: 14,
                          fontWeight: FontWeight.w400),
                  ...
                  Container(
                    ...
                    child: TableCalendar(
                      ...
                      headerStyle: const HeaderStyle(
                          ...
                          headerPadding: EdgeInsets.only(left: 15.0)),
                    ),
                  ),
                  const SizedBox(
                    height: 24,
