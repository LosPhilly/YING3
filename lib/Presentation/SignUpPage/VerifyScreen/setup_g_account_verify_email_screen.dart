...
class SetupGAccountVerifyEmailScreen extends StatefulWidget {
  const SetupGAccountVerifyEmailScreen({Key? key})
      : super(
          key: key,
        );

  @override
  State<SetupGAccountVerifyEmailScreen> createState() =>
      _SetupGAccountVerifyEmailScreenState();
}

class _SetupGAccountVerifyEmailScreenState
    extends State<SetupGAccountVerifyEmailScreen> {
